...
public class GraphRepDumpReaderTest {
	...
	public final void testCreateGraphRep() {
		...
		try {
			...
			assertEquals(0, graphRepDump.source_out[0]);
			assertEquals(0, graphRepDump.source_out[1]);
			assertEquals(1, graphRepDump.source_out[2]);
			assertEquals(1, graphRepDump.source_out[3]);
			assertEquals(2, graphRepDump.source_out[4]);
			...
			assertEquals(13, graphRepDump.mult_out[0]);
			assertEquals(5, graphRepDump.mult_out[1]);
			assertEquals(13, graphRepDump.mult_out[2]);
			assertEquals(8, graphRepDump.mult_out[3]);
			assertEquals(5, graphRepDump.mult_out[4]);
